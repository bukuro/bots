...
def submit_comment(video_link):
        try:
                submission.add_comment('[First half highlights](' + video_link + ')')
        ...
        if (nbaFeed.status is 200):
                ...
                for entry in nbaFeed.entries:
                        ...
                        if (lastEntry == entry.id):
                                ...
                                submissions = r.search('title:\"Game Thread ' + teams_dictionary[team_playing] + '\"', 'nba', 'new', None, 'day')
