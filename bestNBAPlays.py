...
while True:
        response = urllib2.urlopen('http://gdata.youtube.com/feeds/api/users/nba/uploads?v=2&alt=json&q=%22top%22&order‌​by=published&max-results=3').read().decode('utf-8')
